	...
	<div class="logo_wrap">
		<h1>
			<a href="<c:url value="/" />" class="logo logo-light"
				title="Fitness Logo"><span class="blind">Fitness Logo</span></a>
		</h1>
	</div>
	<nav class="gnb_wrap">
		<ul class="gnb">
			...
			<c:choose>
				<c:when test="${not empty sessionScope.user}">
					<c:choose>
						<c:when test="${sessionScope.user.me_authority == 'USER'}">
							<li class="gnb__item"><a
								href="<c:url value='/mypage/membership'/>" class="gnb__link">마이페이지</a></li>
						</c:when>
						<c:when test="${sessionScope.user.me_authority == 'BRADMIN'}">
							<li class="gnb__item"><a
								href="<c:url value='/admin/program/list'/>" class="gnb__link">지점관리</a></li>
						</c:when>
						<c:when test="${sessionScope.user.me_authority == 'HQADMIN'}">
							<li class="gnb__item"><a
								href="<c:url value='/hq/branch/list'/>" class="gnb__link">본사관리</a></li>
						</c:when>
					</c:choose>
					<li class="gnb__item"><a href="<c:url value='/logout'/>"
						class="gnb__link">로그아웃</a></li>
				</c:when>
				<c:otherwise>
		...
		<div class="gnb_side">
			...
			<div class="gnb_side_wrap">
				<a href="javascript:void(0)" class="btn_x js-btn_x"> <span>닫기</span>
					<svg width="25" height="25" viewBox="0 0 23 23" style="enable-background: new 0 0 23 23;" xml:space="preserve">
            			<polygon points="22.5,21.7 12.7,11.9 12.2,11.4 12.2,11.4 12.2,11.4 12.7,10.9 22.5,1.2 21.8,0.5 11.5,10.8 1.2,0.5 0.5,1.2 10.3,10.9 10.8,11.4 10.8,11.4 10.8,11.4 10.3,11.9 0.4,21.7 1.1,22.4 11.5,12.1 21.8,22.4 "></polygon>
          			</svg>
				</a>
				<div class="gnb_side__info_wrap">
					<div class="gnb_side__info">
						<div>
							<a href="<c:url value="/" />" class="gnb_side__logo"
								title="Fitness Logo"><span class="blind">Fitness Logo</span></a>
						</div>
						<div class="textbox">
							<p>
								Lorem ipsum dolor sit amet, consectetur<br> adipiscing
								elit. Pellentesque vitae nunc ut<br> dolor sagittis euismod
								eget sit amet erat.<br> Mauris porta. Lorem ipsum dolor.
							</p>
						</div>
						<div class="textbox">
							<h3 class="gnb_side__title">Working hours</h3>
							<p>
								Monday - Friday:<br>07:00 - 21:00
							</p>
							<p>
								Saturday:<br>07:00 - 16:00
							</p>
							<p>Sunday Closed</p>
						</div>
