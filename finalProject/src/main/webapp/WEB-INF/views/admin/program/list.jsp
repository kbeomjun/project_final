										...
										<tbody>
											<tr>
												...
												<td>
													...
													<div class="error error-program"></div>
												</td>
											</tr>
			...
			<script type="text/javascript">
				...
				$('#form').validate({
				    ...
				    errorPlacement: function(error, element) {
				        if (element.attr("name") == "bp_sp_name") {
				            error.insertAfter("#programSelect"); // 선택창 바로 밑에 오류 메시지 표시
				            error.css("display", "block"); // 오류 메시지 요소에 display:block 적용
				        } else if (element.attr("name") == "bp_total") {
				            error.insertAfter("#bp_total"); // 총 인원수 입력창 밑에 오류 메시지 표시
				        } else {
