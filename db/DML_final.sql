...
values
	('PT문의', '퍼스널 트레이닝(P.T) 가격이 궁금합니다.', '저희 KH Fitness는 모든 트레이너의 금액을 동일하게 운영하고 있습니다. 자세한 내용은 회원권 결제 페이지에서 확인 가능합니다.
 
 수업은 50분 기준으로 진행되며, 등록하는 세션에 따라 할인율이 달라질 수 있습니다.
 
 회원님의 스케줄이나 운동 목표에 따라 프로그램이 달라지기 때문에 지점으로 직접 방문하시어 시설도 둘러보시고 전문적인 트레이너와 맞춤 상담받아보시기를 추천드립니다.', 'FAQ', 'hq_admin@naver.com', '본점'),
    ('PT문의', 'P.T가 뭔가요?', 'P.T는 퍼스널 트레이닝(Personal Training)의 약자로 회원님의 체형, 체력, 운동 경력, 질병 유무 등과 같은 신체 정보뿐만 아니라 다이어트, 체력 증진, 근력 강화, 재활운동 등의 운동 목적과 회원님께서 지닌 잘못된 생활 습관이나 고민, 심리적인 상태까지 고려하여 회원님만을 위한 운동프로그램과 운동 방향을 함께 설정하고 목표를 이루실 수 있도록 이끌어 드리는 과정입니다.
 
 KH Fitness에서는 체계적인 교육을 받은 트레이너들이 정형화된 프로그램이 아닌 회원님의, 회원님에 의한, 회원님을 위한 맞춤 운동 프로그램을 처음부터 끝까지 제공해 드립니다', 'FAQ', 'hq_admin@naver.com', '본점'),
    ('PT문의', 'O.T가 뭔가요?', '신규 회원님들의 원활한 지점 이용을 위해 회원님의 운동 목적 파악 후 그에 맞는 운동 방법과 기구 사용법 등을 전문적인 트레이너가 지도해 드리는 서비스입니다.
 
 O.T 수업을 받지 않고 운동을 시작하게 되시면, 잘못된 운동 방법으로 운동하실 수 있는 확률이 높아 운동 효과를 보지 못하시거나 부상을 당할 염려가 높습니다.
 
 신규 등록 시 안내 데스크에서 O.T 신청서 작성해 주시면, 순차적으로 담당 트레이너 배정 후 O.T가 진행됩니다.', 'FAQ', 'hq_admin@naver.com', '본점'),
    ('기타', '운동을 처음 해보는데, 어떻게 운동해야 하는지 모르겠어요.', '걱정하지 않으셔도 됩니다!
 
 신규 회원 등록 시, 전문적인 트레이너의 1:1 운동 지도 1회를 제공해 드리고 있습니다.
 
 뿐만 아니라, 센터 내에 상주하는 트레이너가 친절하게 도와드리고 있으니 부담 갖지 마시고 언제라도 편하게 트레이너 및 데스크에 문의해 주세요.', 'FAQ', 'hq_admin@naver.com', '본점'),
    ('시설문의', '회원 가입 후 없어지는 헬스장이 많던데 KH는 믿을 수 있을까요?', '저희 KH Fitness는 개인이 운영하는 소규모 헬스장이 아닌 전지점 본사 직영으로만 운영하는 국내 최대 피트니스 전문 기업입니다.
 
 KH를 믿고 편하게 운동하세요!', 'FAQ', 'hq_admin@naver.com', '본점'),
    ('시설문의', '주차 가능한가요?', '지점별로 건물 사정에 따라 주차 가능 여부와 무료 주차 지원 시간이 상이합니다.
 
 홈페이지를 통해 이용을 원하시는 지점의 주차 정보를 확인하실 수 있으며, 더 자세한 정보는 이용하고자 하시는 지점으로 문의해 주세요.
 
 ▶ KH Fitness 홈페이지 : [메뉴] → [지점조회] → [상세검색]', 'FAQ', 'hq_admin@naver.com', '본점'),
    ('이용문의', '다른 지점 이용이 가능하다고 들었는데, 그냥 가면 되는건가요?', '타지점 이용은 KH Fitness  회원권등록 시 KH Fitness 의 모든 센터를 자유롭게 이용하실 수 있는 서비스입니다.', 'FAQ', 'hq_admin@naver.com', '본점'),
    ('이용문의', '개인적으로 준비해야 할 부분이 있을까요?', '1) 샤워 용품
 ...
 3) 개인 운동복
 추가로, 대여용 운동복을 신청하지 않으신 경우에는 개인 운동복도 함께 준비해주세요.', 'FAQ', 'hq_admin@naver.com', '본점'),
    ('이용문의', '이용 요금이 궁금합니다.', '저희 KH Fitness는 전 지점 동일한 금액으로 이용하실 수 있습니다.  자세한 내용은 회원권 결제 페이지에서 확인 가능합니다.', 'FAQ', 'hq_admin@naver.com', '본점'),
    ('이용문의', '홈페이지에 기재된 금액과 결제 시 안내받은 금액이 달라요.', '지점 정보에 명시되어 있는 금액은 정상가이며, 현장 및 온라인 결제 시 상시 할인가 적용된 금액으로 결제하실 수 있습니다.
 
 또한 이벤트 상품 구매 여부에 따라 실결제액은 달라질 수 있다는 점 참고해 주세요.
 
 *이벤트 진행은 지점 별로 상이할 수 있습니다', 'FAQ', 'hq_admin@naver.com', '본점'),
    ('환불문의', '환불 위약금 현금 결제 시 현금 영수증 처리가 가능한가요?', '환불 시 발생되는 위약금은 부가가치세 과세 제외 대상이기 때문에 현금영수증 발행은 불가합니다.
 
 (*부가가치세는 재화 또는 용역을 공급한 경우 과세됩니다. 계약 해지로 인해 발생되는 위약금의 경우에는 부가가치세 과세 대상이 아닙니다.)', 'FAQ', 'hq_admin@naver.com', '본점'),
    ('환불문의', '환불은 어떻게 하나요?', '환불은 환불 신청서 작성 및 공제 금액 확인을 위해 주센터를 방문해 주셔야 합니다. 환불 시 공제 내역은 아래와 같습니다.
 
 ▶ 회원권 : 
  - 이용 시작일 3일 이내 : 결제금액의 10%
  - 이용기간의 1/3 이내 : 결제금액의 50%
  - 이용기간의 2/3 이내 : 결제금액의 90%
  - 이 외 : 환불 불가
 
 ▶ P.T : 총 계약금액의 10% + 계약 해지 시까지 *진행된 세션 비용
 
 - 최초 결제를 카드로 한 경우 공제 금액 선결제 후 카드 전액 취소, 현금으로 결제한 경우 공제 금액을 제외한 차액을 입금합니다. (동일 수단으로만 환불)', 'FAQ', 'hq_admin@naver.com', '본점');
