...
values
  ...
  회원님의 스케줄이나 운동 목표에 따라 프로그램이 달라지기 때문에 지점으로 직접 방문하시어 시설도 둘러보시고 전문적인 트레이너와 맞춤 상담받아보시기를 추천드립니다.</p>', 'FAQ', 'hq_admin@naver.com', '본점'),
  ...
  KH Fitness에서는 체계적인 교육을 받은 트레이너들이 정형화된 프로그램이 아닌 회원님의, 회원님에 의한, 회원님을 위한 맞춤 운동 프로그램을 처음부터 끝까지 제공해 드립니다</p>', 'FAQ', 'hq_admin@naver.com', '본점'),
  ...
  신규 등록 시 안내 데스크에서 O.T 신청서 작성해 주시면, 순차적으로 담당 트레이너 배정 후 O.T가 진행됩니다.</p>', 'FAQ', 'hq_admin@naver.com', '본점'),
    ('기타', '운동을 처음 해보는데, 어떻게 운동해야 하는지 모르겠어요.', '<p>걱정하지 않으셔도 됩니다!</p><p>신규 회원 등록 시, 전문적인 트레이너의 1:1 운동 지도 1회를 제공해 드리고 있습니다.
  
  뿐만 아니라, 센터 내에 상주하는 트레이너가 친절하게 도와드리고 있으니 부담 갖지 마시고 언제라도 편하게 트레이너 및 데스크에 문의해 주세요.<br></p>', 'FAQ', 'hq_admin@naver.com', '본점'),
    ('시설문의', '회원 가입 후 없어지는 헬스장이 많던데 KH는 믿을 수 있을까요?', '<p>저희 KH Fitness는 개인이 운영하는 소규모 헬스장이 아닌 전지점 본사 직영으로만 운영하는 국내 최대 피트니스 전문 기업입니다.</p><p>
  
  KH를 믿고 편하게 운동하세요!</p>', 'FAQ', 'hq_admin@naver.com', '본점'),
  ...
  ▶ KH Fitness 홈페이지 : [메뉴] → [지점조회] → [상세검색]</p>', 'FAQ', 'hq_admin@naver.com', '본점'),
  ...
  3) 개인 운동복
  추가로, 대여용 운동복을 신청하지 않으신 경우에는 개인 운동복도 함께 준비해주세요.</p>', 'FAQ', 'hq_admin@naver.com', '본점'),
  ...
  *이벤트 진행은 지점 별로 상이할 수 있습니다</p>', 'FAQ', 'hq_admin@naver.com', '본점'),
    ('환불문의', '환불 위약금 현금 결제 시 현금 영수증 처리가 가능한가요?', '<p>환불 시 발생되는 위약금은 부가가치세 과세 제외 대상이기 때문에 현금영수증 발행은 불가합니다.
 </p><p> 
  (*부가가치세는 재화 또는 용역을 공급한 경우 과세됩니다. 계약 해지로 인해 발생되는 위약금의 경우에는 부가가치세 과세 대상이 아닙니다.)</p>', 'FAQ', 'hq_admin@naver.com', '본점'),
  ...
  - 최초 결제를 카드로 한 경우 공제 금액 선결제 후 카드 전액 취소, 현금으로 결제한 경우 공제 금액을 제외한 차액을 입금합니다. (동일 수단으로만 환불)</p>', 'FAQ', 'hq_admin@naver.com', '본점');
